...
%   In the second channel of the label picture they have the value 128.
...
%   This means if you train your network with a picture that has 2048*1282
%   pixel your dataset for training has 2625536 samples.
%
...
epochs = 350;   %Number of epochs you want to train the network
alpha = 0.00000165;%Learning rate for the training process

width=2048; %Width of the picture you are working with
height=1282; %Heigth of the picture you are working with
...
inputPicture = imread('test.png');
%Image with the labels corresponding to your inputPicture
labelPicture = imread('test_label.png');
